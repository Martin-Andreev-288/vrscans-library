...
export default function Button({ children, onClick, type }: ButtonProps) {
  ...
  const styles = {
    ...
    createCollectionButton:
      "flex items-center w-full pl-2 bg-gradient-to-br from-blue-500 to-blue-400 text-white hover:from-blue-600 hover:to-blue-500 transition-all shadow-md hover:shadow-lg py-3 rounded-xl font-semibold text-sm",
    sortByButton:
